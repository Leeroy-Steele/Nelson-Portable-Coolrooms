...
export default function Testimonials() {
  ...
  const testimonials = [
    {
      review:
        '"I have purchased 4 trailers from NPC now. These trailers are the best on the market and are built to the best standards"',
      name: "Jacob Chubb. Northland Chiller Rentals",
    },
    {
      review:
        '"Fully customisable, top quality workmanship and excellent follow up support"',
      name: "Jacob Chubb. Northland Chiller Rentals",
    },
    {
      review:
        '"Can’t fault the service, Shane and Rebecca are so helpful and friendly, I would fully recommend NPC to anyone looking at purchasing a chiller trailer or portable coolroom"',
      name: "Jacob Chubb. Northland Chiller Rentals",
    },
    {
      review:
        '"Nelson Portable Coolrooms are always a delight to deal with. Prompt professional service always"',
      name: "Robbie Rankin. RMR Foods Limited",
    },
    {
      review:
        '"We\'ve bought numerous freezers over the past 5 years without any hiccups"',
      name: "Robbie Rankin. RMR Foods Limited",
    },
    {
  ...
  useEffect(() => {
    return () => {
      clearTimeout(update);
    }; //clears the setInterval when component unmounts
  }, []);
